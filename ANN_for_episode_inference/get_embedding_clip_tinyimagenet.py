...
def get_clip():
    ...
    new_transform = transforms.Resize((32, 32))
    preprocess.transforms.insert(0, new_transform)
    # print(preprocess)
...
train_ann_epoch(model, preprocess, train_loader,
                save_path='./embeddings/tinyimagenet_clip_vitl14/train/')
train_ann_epoch(model, preprocess, test_loader,
                save_path='./embeddings/tinyimagenet_clip_vitl14/test/')
